...
export type PokemonSprite = NonNullable<PokemonGraphQL["pokemonsprites"]>[number]["sprites"];
export type PokemonTypeGraphQL = NonNullable<PokemonGraphQL["pokemontypes"]>[number]["type"];
