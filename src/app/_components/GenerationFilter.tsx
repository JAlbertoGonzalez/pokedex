...
export function GenerationFilter() {
  ...
  const { generation, setGeneration, generationMode, setGenerationMode } =
    ...
    <div className="mb-2 flex flex-col gap-2">
      <div className="mb-2 flex items-center justify-between">
        ...
        <div className="flex gap-0">
          <button
            type="button"
            className={`rounded-l-full border border-purple-400 px-3 py-1 text-xs font-bold ${generationMode === "min" ? "bg-green-700 text-white" : "bg-[#23214a] text-yellow-400"}`}
          ...
          <button
            type="button"
            className={`border border-purple-400 px-3 py-1 text-xs font-bold ${generationMode === "exact" ? "bg-green-700 text-white" : "bg-[#23214a] text-yellow-400"}`}
          ...
          <button
            type="button"
            className={`rounded-r-full border border-purple-400 px-3 py-1 text-xs font-bold ${generationMode === "max" ? "bg-green-700 text-white" : "bg-[#23214a] text-yellow-400"}`}
