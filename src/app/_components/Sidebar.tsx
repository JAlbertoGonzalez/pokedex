...
export function Sidebar() {
  ...
  return (
  <aside className="box-border h-full w-full md:w-[24rem] overflow-x-hidden border-r-2 border-purple-900 bg-gradient-to-b from-[#1a1833] to-[#23214a] p-6 shadow-xl">
      <div className="flex h-full flex-col justify-between gap-6">
          {/* Buscador */}
          <div className="flex flex-col gap-4 border border-purple-700 bg-[#23214a] p-4 shadow-md">
            ...
            <button
              type="button"
              className="mt-4 h-10 border border-purple-400 bg-gradient-to-r from-purple-700 to-purple-500 px-4 py-2 font-bold text-white shadow transition hover:bg-purple-800"
